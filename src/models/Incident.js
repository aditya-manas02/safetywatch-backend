...
const incidentSchema = new mongoose.Schema({
  ...
  type: { type: String, enum: ["theft", "vandalism", "suspicious", "assault", "fire", "medical", "hazard", "traffic", "infrastructure", "nuisance", "missing", "harassment", "sos", "other"], required: true },
